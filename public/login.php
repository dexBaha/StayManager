...
<main class="mx-auto grid min-h-[calc(100vh-170px)] max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
    <section class="mx-auto w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-soft">
        ...
        <form class="mt-6 grid gap-5" method="post">
            ...
            <label class="grid gap-2 text-sm font-bold text-slate-700">Password <input class="rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-brand-500 focus:ring-4 focus:ring-brand-100" type="password" name="password" autocomplete="current-password" required></label>
