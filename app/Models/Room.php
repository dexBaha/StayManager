...
class Room
{
    private const ROOM_DETAILS_SELECT = 'SELECT rooms.*, hotels.name AS hotel_name, hotels.city, hotels.country, hotels.stars, hotels.photo_url, hotels.description AS hotel_description,
